...
<ul class="list-group">
  <div><img src="<?php echo base_url('assets/images/wa.jpg') ?>" width="90px"></div>
  <?php foreach($kontak_sidebar as $kontak){?>
  <br>
    <!-- <b><?php echo $kontak->nama_kontak ?></b><br>
    +<?php echo $kontak->nohp ?><br> -->
    <a href="https://api.whatsapp.com/send?phone=+<?php echo $kontak->nohp ?>&text=Hi%20Gan,%20Saya%20mau%20booking%20foto">
